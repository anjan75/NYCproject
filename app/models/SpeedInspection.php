...
class SpeedInspection {
	...
	public function CreateInspection($data = null) {
		...
		$this->db->bind(':DEPARTMENT_ID', 3);//$data['department_id']);
		$this->db->bind(':OCCUPATION_ID', 2);//$data['occupation_id']);
	...
	public function CreateSpeedInspectionObservation($data = null) {
